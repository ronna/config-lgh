...
const cards = [
    ...
    fields: function () {
      ...
      if (report) {
        fields.push(
            ...
            { label: 'contact.profile.days_since_symptoms_onset', value:  getField(report, 'fields.days_since_symptoms_onset'), translate: true, width: 6 },
...

  {
    ...
    fields: function () {
      ...
      const report = getNewestReport(allReports, 'form_a0');
      if (report) {
        const contactRiskFactors = getRiskFactors(getField(report, 'fields.human_exposure.contact_confirmed_cases.contact_confirmed_case'));
